...
public class ASTParser {
	...
	public IBinding[] createBindings(IJavaElement[] elements, IProgressMonitor monitor) {
	 ...
	 // ZALUUM  
	protected org.eclipse.jdt.internal.compiler.env.ICompilationUnit createBasicCompilationUnit(
			org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit) {
		return new BasicCompilationUnit(sourceUnit.getContents(), sourceUnit.getPackageName(), new String(
				sourceUnit.getFileName()), this.project);
	}
	// ZALUUM private
	protected ASTNode internalCreateAST(IProgressMonitor monitor) {
			...
			case K_COMPILATION_UNIT :
				...
				try {
					...
					if (this.typeRoot instanceof ICompilationUnit) {
							 ...
							 */
							//ZALUUM
							// old sourceUnit = createBasicCompilationUnit(sourceUnit)new BasicCompilationUnit(sourceUnit.getContents(), sourceUnit.getPackageName(), new String(sourceUnit.getFileName()), this.project);
